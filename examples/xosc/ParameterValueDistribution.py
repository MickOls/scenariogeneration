...
paramdec.add_parameter(xosc.Parameter(target_param_name,xosc.ParameterType.double,'10'))
...
entities.add_scenario_object(redname,xosc.CatalogReference('VehicleCatalog','car_red'))
...
sce = xosc.Scenario('Parameter_example','Mandolin',paramdec,entities=entities,storyboard = sb,roadnetwork=road,catalog=catalog)
...
pvd = xosc.ParameterValueDistribution('my_parametrization','Mandolin',scenario_filename,stoc)
