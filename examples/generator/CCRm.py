...
class Scenario(ScenarioGenerator):
    ...
    def scenario(self,**kwargs):
        ...
        startpos = 25 + (kwargs['ego_speedvalue']-20)/3.6* (acceleration_time+ttc_at_speed)
        ...
        sce = xosc.Scenario('CCRm_v: ' +str(kwargs['ego_speedvalue']) + ', offset: ' + str(kwargs['offset']),'Mandolin',paramdec,entities=entities,storyboard = sb,roadnetwork=road,catalog=catalog)
        return sce
